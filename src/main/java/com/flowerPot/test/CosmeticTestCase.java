...
public class CosmeticTestCase {
	...
	public List<CosmeticVo> insertCosmeticTestCase() {
		...
		for(int i=1;i<=10;i++) {
			...
			CosmeticVo cosmetic =  new CosmeticVo(0, "name"+i,"code"+i,"type"+i,"sub_type+i" , "brand"+i,"content"+i ,"skinType"+i,1111,"tag"+i,0,0,0,0,true,LocalDateTime.now(),0,0.0,1,"mappingURL"+i,null,null);
