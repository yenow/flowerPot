...
public class AdminCouponController2 {
	
	@Autowired
	private ICoupService service;
	
	@RequestMapping("/coupon")
	public void coupon2(Model model,SearchVO search) {
		List<CoupVo> cList = service.selectCoupList(search);
		model.addAttribute("cList",cList);
	}
	
	@RequestMapping("/couponRegist")
	public String couponRegist2( CoupVo coupon, 
