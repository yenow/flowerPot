...
<body>
	...
	<div class="container-fluid">
		...
		<form
			action="${pageContext.request.contextPath }/customerCenter/enquiry"
			id="enq" method="post" enctype="multipart/form-data">
				...
				<div class="p-r-45 p-r-0-lg">
					<div class="table col-12 board-list ">
						...
						<table class="table table-striped table-sm">
							<tr>
								<td><input type="text" id="title" name="title" size="130"><br>
									<textarea rows="20" cols="100" id="summernote" name="content"
										class="summernote"></textarea></td>

							</tr>

						</table>
						<input type="button" onclick="check();" value="확인" id="submitBtn">
			...
			if ($.trim($("#title").val()) == "") {
				...
				if (text) {
					...
					$
							.ajax({
								type : "post",
								url : "write_ok", //controller mapping address
								headers : {
								...
								success : function() {
									window.location
											.replace("${pageContext.request.contextPath }/customerCenter/enquiry");//성공시 페이지 이동 괄호 안 controller mapping address
								}
							});
				}
			}
