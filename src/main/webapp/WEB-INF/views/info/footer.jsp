	...
	<div class="container">
		<div class="row">
			<div class="col-sm-6 col-lg-3 p-b-50">
				...
				<ul>
					<li class="p-b-10">
						<a href="${pageContext.request.contextPath }/cosmetic/cosmetic_list?type=스킨케어" class="stext-107 cl7 hov-cl1 trans-04"> Skin Care  </a>
					</li>

					<li class="p-b-10">
						<a href="${pageContext.request.contextPath }/cosmetic/cosmetic_list?type=메이크업" class="stext-107 cl7 hov-cl1 trans-04"> Make UP </a>
					</li>

					<li class="p-b-10">
						<a href="${pageContext.request.contextPath }/cosmetic/cosmetic_list?type=바디케어" class="stext-107 cl7 hov-cl1 trans-04"> Body Care</a>
					</li>

					<li class="p-b-10">
						<a href="${pageContext.request.contextPath }/cosmetic/cosmetic_list?type=향수/디퓨져" class="stext-107 cl7 hov-cl1 trans-04"> Perfume / Diffuser </a>
					</li>
					
					<li class="p-b-10">
						<a href="${pageContext.request.contextPath }/cosmetic/cosmetic_list?type=헤어케어" class="stext-107 cl7 hov-cl1 trans-04"> Hair Care </a>
					</li>
					<li class="p-b-10">
						<a href="${pageContext.request.contextPath }/customerCenter/customerCenter?category=FAQ" class="stext-107 cl7 hov-cl1 trans-04">  F A Q </a>
					</li>
				</ul>
			</div>

			<div class="col-sm-6 col-lg-3 p-b-50">
				<h4 class="stext-301 cl0 p-b-30"> Our Company </h4>
			...
			<div class="col-sm-6 col-lg-3 p-b-50">
				...
				<p class="stext-107 cl7 size-201"> 171, Jangseungbaegi-ro, Dongjak-gu, Seoul, Republic of Korea</p>

				<div class="p-t-27" >
					<a href="https://github.com/yenow" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
						<i class="fa fa-pinterest-p"></i>
					신영 github
					</a>

					<a href="https://github.com/jamp0824" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
						<i class="fa fa-pinterest-p"></i>
					준언 github
					</a><br/>

					<a href="https://github.com/YooHyeok" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
						<i class="fa fa-pinterest-p"></i>
					재혁 github
					</a>
					
					<a href="https://github.com/aseongen" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
						<i class="fa fa-pinterest-p"></i>
					성은 github
					</a><br/>
					
					<a href="https://github.com/krinu318995" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
						<i class="fa fa-pinterest-p"></i>
					누리 github
					</a>
		...
		<div class="p-t-40">
			...
			<p class="stext-107 cl6 txt-center">
				...
				<a href="https://colorlib.com" target="_blank">FlowerPot</a>
				&amp; distributed by
				<a href="https://themewagon.com" target="_blank">Light & salt</a>
				<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
