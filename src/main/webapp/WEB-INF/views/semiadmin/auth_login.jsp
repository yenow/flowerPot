            ...
            <div class="card pt-4">
                <div class="card-body">
                    <div class="text-center mb-5">
                        <img src="../resources/semiadmin_css/assets/images/favicon.svg" height="48" class='mb-4'>
                        <h3>Sign In</h3>
                    ...
                    <form action="index">
                        ...
                        <div class="form-group position-relative has-icon-left">
                            <div class="clearfix">
                                ...
                                <a href="auth_forgot_password" class='float-right'>
                        ...
                        <div class='form-check clearfix my-4'>
                            ...
                            <div class="float-right">
                                <a href="authregister">Don't have an account?</a>
                            </div>
                        </div>
                        <div class="clearfix">
