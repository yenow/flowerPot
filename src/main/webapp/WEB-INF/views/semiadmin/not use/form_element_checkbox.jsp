...
<head>
    ...
    <title>Checkbox - Voler Admin Dashboard</title>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <code>.form-check-input</code> class.</p>
                            <ul class="list-unstyled mb-0">
                                <li class="d-inline-block mr-2 mb-1">
                                    <div class='form-check'>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <p>Use class <code>.form-check-glow</code> class with <code>.form-check-input.form-check-{colorName}</code>
                            ...
                            <ul class="list-unstyled mb-0">
                                <li class="d-inline-block mr-2 mb-1">
                                    <div class='form-check'>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="form-check-input form-check-primary form-check-glow" checked name="customCheck"
                                ...
                                <li class="d-inline-block mr-2 mb-1">
                                    <div class='form-check'>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="form-check-input form-check-secondary form-check-glow" checked name="customCheck"
                                ...
                                <li class="d-inline-block mr-2 mb-1">
                                    <div class='form-check'>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="form-check-input form-check-success form-check-glow" checked name="customCheck"
                                ...
                                <li class="d-inline-block mr-2 mb-1">
                                    <div class='form-check'>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="form-check-input form-check-danger form-check-glow" checked name="customCheck"
                                ...
                                <li class="d-inline-block mr-2 mb-1">
                                    <div class='form-check'>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="form-check-input form-check-info form-check-glow" checked name="customCheck"
                                ...
                                <li class="d-inline-block mb-1">
                                    <div class='form-check'>
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="form-check-input form-check-warning form-check-glow" checked name="customCheck"
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <p>To add a checkBox with different sizes, we have the <code>.form-check-sm</code> class for small
                                Checkboxes. Add it alongwith <code>.form-check</code> class.</p>
                            <ul class="list-unstyled mb-0">
                                <li class="d-inline-block mb-1 mr-2">
