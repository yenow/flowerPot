...
<head>
    ...
    <title>Pricing - Voler Admin Dashboard</title>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Pricing</h3>
                <p class="text-subtitle text-muted">Nice pricing list that you can use for sell some stuff.</p>
            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-4 px-0">
                            <div class="card">
                                ...
                                <ul>
                                    <li><i data-feather="check-circle"></i>Lorem ipsum dolor sit amet</li>
                                    <li><i data-feather="check-circle"></i>Lorem ipsum dolor sit </li>
                                    <li><i data-feather="check-circle"></i>Lorem ipsum dolor  amet</li>
                                    <li><i data-feather="check-circle"></i>Lorem ipsum dolor sit amet</li>
                                    <li><i data-feather="check-circle"></i>Lorem ipsum  sit amet</li>
                                    <li><i data-feather="check-circle"></i>Lorem  dolor sit amet</li>
                                </ul>
