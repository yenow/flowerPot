...
<head>
    ...
    <title>Select - Voler Admin Dashboard</title>
    
<!-- Include base CSS (optional) -->
<link rel="stylesheet" href="../resources/semiadmin_css/assets/vendors/choices.js/base.min.css" />
<!-- Include Choices CSS -->
<link rel="stylesheet" href="../resources/semiadmin_css/assets/vendors/choices.js/choices.min.css" />
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 mb-4 order-md-1 order-last">
                <h3>Select</h3>
                <p class="text-subtitle text-muted">Advanced select field that makes you easier to select data.</p>
            </div>
            <div class="col-12 col-md-6 mb-4 order-md-2 order-first">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="alert alert-primary">
                                        <a href="https://choices.org/getting-started/installation" target="_blank">Click here</a> for more information 
                                    </div>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <h6>Basic Choices</h6>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <p>Use <code>.multiple-remove</code> attribute for multiple select box with remove button.</p>
                                    <div class="form-group">
...
<script src="../resources/semiadmin_css/assets/vendors/choices.js/choices.min.js"></script>
