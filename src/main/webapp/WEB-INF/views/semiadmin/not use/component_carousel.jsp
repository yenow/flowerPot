        ...
        <ul class="menu">
                ...
                <li class="sidebar-item  has-sub">
                    ...
                    <ul class="submenu ">
                        ...
                        <li>
                            <a href="ui_chart_apexchart">Apet</a>
                        </li>
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Carousel</h3>
                <p class="text-subtitle text-muted">A slideshow component for cycling through elements—images or slides of text—like a carousel.</p>
            </div>
                ...
                <div class="row">
                        ...
                        <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../resources/semiadmin_css/assets/images/samples/inspirational-aerial-landscape-autumn-forest-and-FU2LKHA.jpg" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="../resources/semiadmin_css/assets/images/samples/road-over-dutch-dike-PLN5XJR.jpg" class="d-block w-100" alt="...">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../resources/semiadmin_css/assets/images/samples/inspirational-aerial-landscape-autumn-forest-and-FU2LKHA.jpg" class="d-block w-100"
                                        alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="../resources/semiadmin_css/assets/images/samples/road-over-dutch-dike-PLN5XJR.jpg" class="d-block w-100" alt="...">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="../resources/semiadmin_css/assets/images/samples/amazing-animal-beautiful-beautifull.jpg" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="../resources/semiadmin_css/assets/images/samples/pexels-photo-443446.jpeg" class="d-block w-100" alt="...">
                                </div>
                                <div class="carousel-item">
                                    <img src="../resources/semiadmin_css/assets/images/samples/" class="d-block w-100" alt="...">
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">  
                            ...
                            <div class="carousel-inner" >
                                ...
                                <div class="carousel-item">
                                    <img src="../resources/semiadmin_css/assets/images/samples/moody-autumn-day-in-the-dolomites-forest-and-MBFNHV2.jpg" class="d-block w-100" alt="...">
                                    <div class="carousel-caption d-none d-md-block">
