            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident nostrum numquam reprehenderit facilis. Dolor blanditiis commodi voluptate esse voluptatum aut natus, distinctio at, officiis ipsam molestiae doloribus ratione corrupti dolorum.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Use <code>.divider-text</code> and wrapped by <code>.divider</code> to create a divider text </p>
                        <div class="divider">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Use <code>.divider-{left|left-center|right-center|right}</code> and with <code>.divider</code> to change the text position </p>
