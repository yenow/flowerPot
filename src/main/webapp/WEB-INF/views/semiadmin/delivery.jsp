						...
						<div class="col-12 col-md-6 order-md-2 order-first">
							<nav aria-label="breadcrumb" class='breadcrumb-header'>
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">배송관리</li>
								</ol>
							</nav>
						</div>
					</div>
								...
								<tbody>
									<c:forEach var="op" items="${opList}">
										<tr>
											...
											<td class="text-nowrap"><a href="${pageContext.request.contextPath }/semiadmin/delivery_complete?ono=${op.ono }&cno=${op.cno }" data-ono="${op.ono }" class="btn btn-outline-secondary">배송완료</a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
