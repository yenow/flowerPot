		...
		<div class="main-panel">
			...
			style="background-color: white; border: 2px solid #9765da; WIDTH: 60px; color: black; "> Q&A </button>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="header">
									<h4 class="title" style="display:inline-block;">Q & A</h4>
			<button class="btn btn-izone btn-flat pull-right" 
			...
			style="background-color: #9765da; color: white; ">등록</button>
								...
								<div class="content table-responsive table-full-width">
									<table class="table table-hover table-striped">
										...
										<tbody>
											<c:forEach var="qANDa" items="${qList}">
												<tr>
													<td>${qANDa.ccno}</td>
													<td>${qANDa.title}</td>
													<td>
													...
													<td><button onclick="location='${pageContext.request.contextPath}/admin/customer/q&a_content/${qANDa.ccno}'">내용</button>
													<button onclick="location='${pageContext.request.contextPath}/admin/customer/q&a_del/${qANDa.ccno}'">삭제</button></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
