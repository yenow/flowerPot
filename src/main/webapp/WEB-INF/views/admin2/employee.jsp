...
$(function() {
	$('#searchBtn').click(function(){
		...
		location.href="${pageContext.request.contextPath}/admin2/employee?keyword="+keyword+"&condition="+condition;
	});
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="${pageContext.request.contextPath}/admin2/empAdd" method="post" onsubmit="return check();">
                                    <div class="row">
                                        <div class="col-md-2">
										...
										<tbody>
											<c:forEach var="emp" items="${eList}">
												<tr>
													...
													<td><button class=" pull-right" onclick="location='${pageContext.request.contextPath}/admin2/employee/signUp'">아이디 발급</button></td>
										...
										<ul class="pagination justify-content-center">
											...
											<c:if test="${pc.prev}">
												<li class="page-item"><a class="page-link"
													href="<c:url value='/admin2/employee/${pc.makeURI(pc.beginPage - 1)}' />"
											...
											<c:forEach var="pageNum" begin="${pc.beginPage}"
												...
												<li class="page-item"><a
													href="<c:url value='/admin2/employee/${pc.makeURI(pageNum)}'/>"
											...
											<c:if test="${pc.next}">
												<li class="page-item"><a class="page-link"
													href="<c:url value='/admin2/employee/${pc.makeURI(pc.endPage + 1)}' />"
