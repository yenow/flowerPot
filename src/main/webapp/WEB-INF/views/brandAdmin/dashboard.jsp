...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="${path }/resources/brandAdmin/${path }/resources/brandAdmin/assets/images/favicon.png">
    <title>Matrix Template - The Ultimate Multipurpose admin template</title>
    <!-- Custom CSS -->
    <link href="${path }/resources/brandAdmin/assets/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="${path }/resources/brandAdmin/dist/css/style.min.css" rel="stylesheet">
...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="${path }/resources/brandAdmin/assets/images/logo-icon.png" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="${path }/resources/brandAdmin/assets/images/logo-text.png" alt="homepage" class="light-logo" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="${path }/resources/brandAdmin/assets/images/users/1.jpg" alt="user" class="rounded-circle" width="31"></a>
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2"><img src="${path }/resources/brandAdmin/assets/images/users/1.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="${path }/resources/brandAdmin/assets/images/users/4.jpg" alt="user" width="50" class="rounded-circle"></div>
                                ...
                                <!-- Comment Row -->
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2"><img src="${path }/resources/brandAdmin/assets/images/users/5.jpg" alt="user" width="50" class="rounded-circle"></div>
                                    <div class="comment-text w-100">
                                    ...
                                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                                        <li class="list-group-item todo-item" data-role="task">
                                            ...
                                            <ul class="list-style-none assignedto">
                                                <li class="assignee"><img class="rounded-circle" width="40" src="${path }/resources/brandAdmin/assets/images/users/1.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="${path }/resources/brandAdmin/assets/images/users/2.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="${path }/resources/brandAdmin/assets/images/users/3.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                                <li class="assignee"><img class="rounded-circle" width="40" src="${path }/resources/brandAdmin/assets/images/users/4.jpg" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                                            </ul>
                                        </li>
                                        <li class="list-group-item todo-item" data-role="task">
                                            <div class="custom-control custom-checkbox">
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="${path }/resources/brandAdmin/assets/images/users/1.jpg" alt="user"></div>
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="${path }/resources/brandAdmin/assets/images/users/2.jpg" alt="user"></div>
                                            <div class="chat-content">
                                        ...
                                        <!--chat Row -->
                                        <li class="chat-item">
                                            <div class="chat-img"><img src="${path }/resources/brandAdmin/assets/images/users/3.jpg" alt="user"></div>
                                            <div class="chat-content">
                            ...
                            <div class="tab-content tabcontent-border">
                                <div class="tab-pane active" id="home" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <img src="${path }/resources/brandAdmin/assets/images/background/img4.jpg" class="img-fluid">
                                    </div>
                                </div>
    ...
    <!-- All Jquery -->
    <!-- ============================================================== -->
    <script src="${path }/resources/brandAdmin/assets/libs/jquery/${path }/resources/brandAdmin/dist/jquery.min.js"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="${path }/resources/brandAdmin/assets/libs/popper.js/${path }/resources/brandAdmin/dist/umd/popper.min.js"></script>
    <script src="${path }/resources/brandAdmin/assets/libs/bootstrap/${path }/resources/brandAdmin/dist/js/bootstrap.min.js"></script>
    <script src="${path }/resources/brandAdmin/assets/libs/perfect-scrollbar/${path }/resources/brandAdmin/dist/perfect-scrollbar.jquery.min.js"></script>
    <script src="${path }/resources/brandAdmin/assets/extra-libs/sparkline/sparkline.js"></script>
    <!--Wave Effects -->
    <script src="${path }/resources/brandAdmin/dist/js/waves.js"></script>
    <!--Menu sidebar -->
    <script src="${path }/resources/brandAdmin/dist/js/sidebarmenu.js"></script>
    <!--Custom JavaScript -->
    <script src="${path }/resources/brandAdmin/dist/js/custom.min.js"></script>
    <!--This page JavaScript -->
    <!-- <script src="${path }/resources/brandAdmin/dist/js/pages/dashboards/dashboard1.js"></script> -->
    <!-- Charts js Files -->
    <script src="${path }/resources/brandAdmin/assets/libs/flot/excanvas.js"></script>
    <script src="${path }/resources/brandAdmin/assets/libs/flot/jquery.flot.js"></script>
    <script src="${path }/resources/brandAdmin/assets/libs/flot/jquery.flot.pie.js"></script>
    <script src="${path }/resources/brandAdmin/assets/libs/flot/jquery.flot.time.js"></script>
    <script src="${path }/resources/brandAdmin/assets/libs/flot/jquery.flot.stack.js"></script>
    <script src="${path }/resources/brandAdmin/assets/libs/flot/jquery.flot.crosshair.js"></script>
    <script src="${path }/resources/brandAdmin/assets/libs/flot.tooltip/js/jquery.flot.tooltip.min.js"></script>
    <script src="${path }/resources/brandAdmin/dist/js/pages/chart/chart-page-init.js"></script>
