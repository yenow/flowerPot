...
<body>
	...
	<div class="container-fluid">
		...
		<form action="${pageContext.request.contextPath}/comments/q&aComnt_write_ok" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
				<div class="input-group">
					...
					<input type="text" class="form-control" id="username" name="replytitle" placeholder="제목" required="">
			...
			<!-- 내용 -->
			<div class="mb-2">
				<textarea id="summernote" name="replytext"></textarea>
			</div>
			<!-- 제출 -->
