...
$(function() {
	$('#searchBtn').click(function(){
		...
		location.href="${pageContext.request.contextPath}/admin/brand?keyword="+keyword+"&condition="+condition;
	});
										...
										<ul class="pagination justify-content-center">
											...
											<c:if test="${pc.prev}">
												<li class="page-item"><a class="page-link"
													href="<c:url value='/admin/brand${pc.makeURI(pc.beginPage - 1)}' />"
											...
											<c:forEach var="pageNum" begin="${pc.beginPage}"
												...
												<li class="page-item"><a
													href="<c:url value='/admin/brand${pc.makeURI(pageNum)}'/>"
											...
											<c:if test="${pc.next}">
												<li class="page-item"><a class="page-link"
													href="<c:url value='/admin/brand${pc.makeURI(pc.endPage + 1)}' />"
