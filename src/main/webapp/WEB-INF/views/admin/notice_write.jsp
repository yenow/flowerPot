...
<body>
	...
	<div class="container-fluid">
		<h2 class="text-center my-3">공지사항 등록</h2>
		<form action="${pageContext.request.contextPath}/admin/customer/notice_write_ok" method="post" enctype="multipart/form-data">
