...
<body>
	...
	<div class="container-fluid">
		<h2 class="text-center my-3">공지사항 수정</h2>
		<form action="${pageContext.request.contextPath}/admin/customer/notice_modify_ok" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
				<div class="input-group">
					...
					<input type="text" class="form-control" id="username" name="title" placeholder="Username" required="" value="${notice.title}">
			...
			<div class="text-center">
				<input type="submit" class="btn btn-primary" style="background-color: #212b52; border: 1px solid #212b52; color: white; opacity: 0.9" value="수정">
