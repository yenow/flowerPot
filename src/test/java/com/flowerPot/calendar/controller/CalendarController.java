package com.flowerPot.calendar.controller;
...
import com.flowerPot.calendar.GooleCalendarService;
import com.flowerPot.calendar.model.CalendarDto;
...
public class CalendarController {
	...
	public List<Event> calendarEventList(CalendarDto calDto) {
		...
		try {
			com.google.api.services.calendar.Calendar service = GooleCalendarService.getCalendarService();
			Events events = service.events().list(calDto.getCalendarId()).setOrderBy("startTime").setSingleEvents(true)
					.execute();
	...
	public Map<String, Boolean> calendarEventAdd(CalendarDto calDto) {
		...
		try {
			Calendar service = GooleCalendarService.getCalendarService();
